import {
    experienceTheIsabellaOasis, experienceHouseOfTunes, yourBirthdayYourWay,
    whyPrivateJetTravelIsWorthIT, theRealCostOfFlyingPrivate, theFlightYouDeserve,
    fuelArbitrage, howToMakeYourNextStayUnforgettableWithConciergeServices,
    vehicleTravelRedefined, theDifferenceBetweenBrokersAndOperatorsInPrivateJetTravel

} from '../assets/chronicles/chronicles.mjs'
const articles = [
    {
